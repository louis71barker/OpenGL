...
# Project:  particleSystem/Opengl.pro
# Template: app
# Command: /opt/Qt/5.3/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile particleSystem/Opengl.pro
#############################################################################
...
INCPATH       = -I/opt/Qt/5.3/gcc_64/mkspecs/linux-clang -IparticleSystem -I/opt/Qt/5.3/gcc_64/include -I/opt/Qt/5.3/gcc_64/include/QtGui -I/opt/Qt/5.3/gcc_64/include/QtCore -I. -I.
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/Qt/5.3/gcc_64 -Wl,-rpath,/opt/Qt/5.3/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lGLU -L/opt/Qt/5.3/gcc_64/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		particleSystem/particleSystem/Opengl.pro src/*.cpp
QMAKE_TARGET  = OpenGL
...
Makefile: particleSystem/Opengl.pro .qmake.cache /opt/Qt/5.3/gcc_64/mkspecs/linux-clang/qmake.conf /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt/5.3/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/features/lex.prf \
		particleSystem/Opengl.pro \
		/opt/Qt/5.3/gcc_64/lib/libQt5Gui.prl \
		/opt/Qt/5.3/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile particleSystem/Opengl.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/OpenGL1.0.0/ && $(COPY_FILE) --parents src/*.cpp .tmp/OpenGL1.0.0/ && (cd `dirname .tmp/OpenGL1.0.0` && $(TAR) OpenGL1.0.0.tar OpenGL1.0.0 && $(COMPRESS) OpenGL1.0.0.tar) && $(MOVE) `dirname .tmp/OpenGL1.0.0`/OpenGL1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/OpenGL1.0.0
...
*.o: src/*.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o *.o src/*.cpp
